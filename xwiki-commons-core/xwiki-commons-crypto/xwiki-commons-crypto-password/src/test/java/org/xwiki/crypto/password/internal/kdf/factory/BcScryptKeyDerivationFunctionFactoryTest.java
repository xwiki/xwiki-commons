 ...
 */
@ComponentTest
class BcScryptKeyDerivationFunctionFactoryTest
{
    @InjectMockComponents
    private BcScryptKeyDerivationFunctionFactory factory;

    private KeyDerivationFunction getKDFInstance(ScryptParameters parameters)
    {
    ...
    @Test
    void scryptSerializationDeserializationTest() throws Exception
    {
