...
/**
 * @param <F> the type of the filter supported by this {@link InputFilter}
 * @version $Id$
 * @since 6.2M1
 */
public abstract class AbstractBeanInputFilterStream<P, F> implements BeanInputFilter<P>, Initializable
{
    @Inject
