 ...
 * @since 42.0.0
 */
public class JakartaToJavaxEnumeration<I extends Enumeration<X>, X, K> extends AbstractJakartaToJavaxWrapper<I>
    implements Enumeration<K>
{
     ...
     */
    public JakartaToJavaxEnumeration(I wrapped, Function<K, X> javaxProvider, Function<X, K> jakartaProvider)
    {
        super(wrapped);
