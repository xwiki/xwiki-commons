 ...
 * @since 17.0.0RC1
 */
public class JavaxToJakartaServletResponse<R extends jakarta.servlet.ServletResponse>
    extends AbstractJavaxToJakartaWrapper<R> implements ServletResponse
{
    /**
     * @param jakarta the wrapped version
     */
    public JavaxToJakartaServletResponse(R jakarta)
    {
        super(jakarta);
    }
