...
public final class JakartaServletBridge
{
     ...
     */
    private static <K, X> X toJavax(K jakarta, Function<K, X> constructor)
    {
        X javax;
     ...
     */
    private static <X, K> K toJakarta(X javax, Function<X, K> constructor)
    {
        K jakarta;
    ...
    {
        return toJavax(jakarta, JavaxToJakartaCookie::new);
    }
    ...
    {
        return toJavax(javax, JakartaToJavaxCookie::new);
    }
    ...
    public static EnumSet<javax.servlet.DispatcherType> toJavax(EnumSet<DispatcherType> jakarta)
    {
        ...
        return EnumSet.copyOf(jakarta.stream().map(JakartaServletBridge::toJavax).collect(Collectors.toList()));
    }
    ...
    public static EnumSet<DispatcherType> toJakarta(EnumSet<javax.servlet.DispatcherType> javax)
    {
        ...
        return EnumSet.copyOf(javax.stream().map(JakartaServletBridge::toJakarta).collect(Collectors.toList()));
    }
