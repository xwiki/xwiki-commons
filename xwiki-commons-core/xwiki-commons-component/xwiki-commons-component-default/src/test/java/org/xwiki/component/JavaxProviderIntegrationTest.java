...
class JavaxProviderIntegrationTest
{
    ...
    void loadAndInjectProviderWhenExceptionInInitialize()
    {
        ...
        assertEquals("Failed to lookup component "
            + "[org.xwiki.component.JavaxProviderIntegrationTest$TestComponentWithProviderInException] identified by "
            + "type [interface org.xwiki.component.JavaxProviderIntegrationTest$TestComponentRole] and hint [exception]",
            exception.getMessage());
        assertEquals("Failed to lookup component "
            + "[org.xwiki.component.JavaxProviderIntegrationTest$TestProviderWithExceptionInInitialize] identified by "
            + "type [javax.inject.Provider<java.lang.String>] and hint [exception]", exception.getCause().getMessage());
