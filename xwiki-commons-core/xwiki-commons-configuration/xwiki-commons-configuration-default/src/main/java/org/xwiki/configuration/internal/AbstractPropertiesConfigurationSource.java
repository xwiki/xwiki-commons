...
/**
 * Helper to implement a {@link ConfigurationSource} with automatic conversion of property values base on the
 * xwiki-properties framework.
 * 
 * @version $Id$
 * @since 17.3.0RC1
 */
    ...
    public <T> T getProperty(String key, T defaultValue)
    {
        ...
        if (containsKey(key)) {
            if (defaultValue != null) {
                result = getProperty(key, (Class<T>) defaultValue.getClass());
            } else {
