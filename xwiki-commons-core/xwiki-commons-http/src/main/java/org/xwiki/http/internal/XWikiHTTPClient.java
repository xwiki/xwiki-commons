...
public class XWikiHTTPClient implements Closeable
{
    ...
    {
        return this.client.execute(request, getHttpClientContext(request, credentials), responseHandler);
    }
     ...
     * @throws IOException in case of a problem or the connection was aborted
     */
    public <T> T executeGet(String uri, HttpClientResponseHandler<? extends T> responseHandler) throws IOException
    {
     ...
     * @throws IOException in case of a problem or the connection was aborted
     */
    public <T> T executePut(String uri, HttpEntity entity, HttpClientResponseHandler<? extends T> responseHandler)
        throws IOException
    {
