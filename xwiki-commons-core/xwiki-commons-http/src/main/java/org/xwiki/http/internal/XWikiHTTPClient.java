...
public class XWikiHTTPClient implements Closeable
{
     ...
     */
    public XWikiHTTPClient(String userAgent)
    {
        // Create a client pre-configured with standard JVM configuration (proxies, etc.)
        this(HttpClients.custom().useSystemProperties().setUserAgent(userAgent).build());
    }
    ...
    public XWikiHTTPClient(String userAgent, int timeout)
    {
        ...
        // Create a client pre-configured with standard JVM configuration (proxies, etc.)
        this.client =
            HttpClients.custom().setConnectionManager(cm).useSystemProperties().setUserAgent(userAgent).build();
    }
