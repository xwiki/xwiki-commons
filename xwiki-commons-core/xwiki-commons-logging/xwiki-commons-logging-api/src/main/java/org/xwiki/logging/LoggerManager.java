...
public interface LoggerManager
{
     ...
     * <p>
     * Note that the logs generated by the current thread will not sent anymore to the logging system implementing the
     * SLF4J API. They will be only be received as XWiki events sent to the provided listener. In addition, it
