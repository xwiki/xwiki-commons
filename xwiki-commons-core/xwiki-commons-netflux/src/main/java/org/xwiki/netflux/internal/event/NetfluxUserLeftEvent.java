 ...
 * @since 17.10.0RC1
 */
public class NetfluxUserLeftEvent implements Event, Serializable
{
     ...
     */
    public NetfluxUserLeftEvent(String userId, String channelKey, String reason)
    {
        this.user = userId;
    ...
    {
        return otherEvent instanceof NetfluxUserLeftEvent;
    }
}
