...
/**
 * Exception raised when no handler can be found for a given {@link User}.
 *
 * @version $Id$
 * @since 17.10.0RC1
 */
public class NoUserHandlerException extends NetfluxException
{
    /**
     ...
     */
    public NoUserHandlerException(String message)
    {
        super(message);
    }
     ...
     */
    public NoUserHandlerException(String message, Throwable cause)
    {
        super(message, cause);
    }
}
