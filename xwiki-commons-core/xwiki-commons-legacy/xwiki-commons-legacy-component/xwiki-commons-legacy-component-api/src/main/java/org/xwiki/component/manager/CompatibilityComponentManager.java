...
public interface CompatibilityComponentManager
{
     ...
     * @deprecated use {@code #getInstance(java.lang.reflect.Type)} instead
     */
     ...
     * @return the component instance
     * @throws ComponentLookupException in case the component cannot be found
     * @deprecated use {@code #getInstance(java.lang.reflect.Type, String)} instead
     */
    @Deprecated(since = "4.0M1")
     ...
     * @deprecated use {@code #getInstanceList(java.lang.reflect.Type)} instead
     */
    @Deprecated(since = "4.0M1")
     ...
     * @return the components
     * @throws ComponentLookupException if any error happen during component search
     * @deprecated use {@code #getInstanceMap(java.lang.reflect.Type)} instead
     */
    @Deprecated(since = "4.0M1")
     ...
     * @deprecated use {@code #hasComponent(Type)} instead
     */
    @Deprecated(since = "4.0M1")
     ...
     * @deprecated use {@code #hasComponent(Type, String)} instead
     */
    @Deprecated(since = "4.0M1")
     ...
     * @since 2.0M2
     * @deprecated use {@code #unregisterComponent(Type, String)} instead
     */
    @Deprecated(since = "4.0M1")
     ...
     * @since 2.0M1
     * @deprecated use {@code #getComponentDescriptor(Type, String)} instead
     */
    @Deprecated(since = "4.0M1")
