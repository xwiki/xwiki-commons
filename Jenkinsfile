    ...
    'quality': {
      node {
        ...
        xwikiBuild('Quality') {
          ...
          properties = '--settings /home/hudsonagent/.m2/xwiki-commons-settings.xml -Dxwiki.jacoco.itDestFile=`pwd`/target/jacoco-it.exec -Djvm=/home/hudsonagent/java8/bin/java'
          sonar = true
          javadoc = false
