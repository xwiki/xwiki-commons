 ...
 * @since 5.0M1
 */
public abstract class AbstractXWikiClassCouplingCheck extends Check
{
    ...
    private class Context
    {
        ...
        {
            // TODO: Bug here: the passed class name is not the fully qualified name, hence the passed classes never
            // start with "java.lang"... See https://sourceforge.net/p/checkstyle/bugs/684/
